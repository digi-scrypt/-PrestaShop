...
class CarrierCore extends ObjectModel
{
     ...
     */
    public static function getCarriers($id_lang, $active = false, $delete = false, $id_zone = false, $ids_group = null, $modules_filters = self::ALL_CARRIERS)
    {
    ...
    public static function getCarriersForOrder($id_zone, $groups = null, $cart = null, &$error = [])
    {
        ...
        $result = Carrier::getCarriers((int) $id_lang, true, false, (int) $id_zone, $groups, self::ALL_CARRIERS);
        $results_array = [];
