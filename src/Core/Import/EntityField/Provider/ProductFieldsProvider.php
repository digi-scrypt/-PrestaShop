...
final class ProductFieldsProvider implements EntityFieldsProviderInterface
{
    ...
    public function getCollection()
    {
        $fields = [
            ...
            new EntityField('reduction_price', $this->trans('Discount amount (use 0 to delete existing specific prices)', 'Admin.Advparameters.Feature')),
            new EntityField('reduction_percent', $this->trans('Discount percent (use 0 to delete existing specific prices)', 'Admin.Advparameters.Feature')),
